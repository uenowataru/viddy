...
UserControl.prototype = {
  ...
  setThumbnailImageL: function(){
      var prevId = video_list.getPrevVideo()[0];
      if( $('#arrowL').attr("src") != 'http://img.youtube.com/vi/' + prevId +  '/0.jpg'){
        $('#arrowL').attr("src", 'http://img.youtube.com/vi/' + prevId +  '/0.jpg');
      }
  },

  setThumbnailImageR: function(){
      var nextId = video_list.getNextVideo()[0];
