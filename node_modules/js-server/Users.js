module.exports = {
	...
	updateUserLikedVideos: function(userId, updown, videoId){
		updateUserLikes(userId, updown, videoId);
	}
};
...
function updateUserLikes(userId, updown, videoId){
	if(updown=='up'){
...
function addUserLikedVideos(userId, videoId){
	console.log(userId + 'adding ' + videoId);
	mongodb.addUserLikesToDB(userId,videoId);
}
